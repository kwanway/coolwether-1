package com.example.xxzxxz.coolweather;
...
import com.example.xxzxxz.coolweather.gson.Forecast;
import com.example.xxzxxz.coolweather.gson.Weather;
import com.example.xxzxxz.coolweather.util.HttpUtil;
import com.example.xxzxxz.coolweather.util.Utility;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId){
        String weatherUrl="http://guolin.tech/api/weather?cityid="+
                weatherId+"&key=febacdb6b9164b7982286d05a5f97375";
